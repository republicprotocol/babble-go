...
func (*BroadcastRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_cbacdf251b0c79c5, []int{0}
}
...
func (*BroadcastResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_cbacdf251b0c79c5, []int{1}
}
...
// XoxoServiceClient is the client API for XoxoService service.
//
...
func NewXoxoServiceClient(cc *grpc.ClientConn) XoxoServiceClient {
	return &xoxoServiceClient{cc}
}

func (c *xoxoServiceClient) Broadcast(ctx context.Context, in *BroadcastRequest, opts ...grpc.CallOption) (*BroadcastResponse, error) {
	out := new(BroadcastResponse)
	err := c.cc.Invoke(ctx, "/grpc.XoxoService/Broadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// XoxoServiceServer is the server API for XoxoService service.
type XoxoServiceServer interface {
	Broadcast(context.Context, *BroadcastRequest) (*BroadcastResponse, error)
}

func RegisterXoxoServiceServer(s *grpc.Server, srv XoxoServiceServer) {
	s.RegisterService(&_XoxoService_serviceDesc, srv)
}

func _XoxoService_Broadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
var _XoxoService_serviceDesc = grpc.ServiceDesc{
...
func init() { proto.RegisterFile("grpc.proto", fileDescriptor_grpc_cbacdf251b0c79c5) }

var fileDescriptor_grpc_cbacdf251b0c79c5 = []byte{
